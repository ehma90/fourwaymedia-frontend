...
export function ShopTemplateCard({ template, onOpen }: ShopTemplateCardProps) {
  return (
    <button
      type="button"
      onClick={onOpen}
      className="group flex w-full flex-col cursor-pointer overflow-hidden rounded-2xl border border-neutral-200/90 bg-white text-left shadow-[0_1px_0_rgba(255,255,255,0.04)_inset] outline-none transition-[transform,box-shadow] hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(0,0,0,0.1)] focus-visible:ring-2 focus-visible:ring-[#FEC107]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background dark:border-white/10 dark:bg-neutral-900 dark:hover:shadow-[0_12px_40px_rgba(0,0,0,0.35)]"
