  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-2 lg:gap-16 xl:gap-20">
        <div className="min-w-0 font-[family-name:var(--font-lexend),system-ui,sans-serif]">
          <h2
            id="why-work-heading"
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              <span
                className="absolute -bottom-1 left-0 h-0.5 w-full rounded-full bg-[#e8a317] sm:-bottom-1.5 sm:h-1.5 dark:bg-[#f2b01e]"
                aria-hidden
              />
            </span>{" "}
            with us
        ...
        <div className="min-w-0">
          <div className="flex flex-col gap-3 sm:gap-4">
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <div className="overflow-hidden rounded-xl border border-neutral-200/90 bg-white shadow-[0_8px_30px_rgba(0,0,0,0.06)] sm:rounded-2xl dark:border-white/10 dark:bg-neutral-900/40 dark:shadow-[0_8px_40px_rgba(0,0,0,0.35)]">
                <img
